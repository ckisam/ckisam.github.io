$(function () {
    var myChart = Highcharts.chart('evol_nb_cor', {
            ...
            data: [651,470,496,473,580,740,923,1319,1526,2661,2662,2585,2545,2870,3495,2915,2860,3184,3720,4323,3887,4683,5073,747,3458,3081,3056,3200,933,1395,1813,1907,1332,1262,1162,2009,2749,3241,4803,4719,4822,{y:5071, marker: {radius: 10, symbol: 'url(images/explosion.png)'}, name: "Attentats du 11 septembre 2001, New York"},8500,11996,16860,14852,13488]},
        {
            type : 'spline',
            name: 'Victimes',
            data: [171,173,566,370,542,617,672,456,1459,2100,4391,4851,5135,9444,10450,7094,4976,6476,7189,8136,7148,8429,9745,7691,6094,6965,10928,4688,3388,4402,7743,4799,3278,5718,6313,9362,12858,9135,9271,7727,8228,15436,22234,43566,38464,34676]},
        {
            type : 'spline',
    ...
    // Graphique de Juju
    var jujuChart = Highcharts.chart('evol_nb_region', {
        title: {
            text: ''
        },
        credits: {
